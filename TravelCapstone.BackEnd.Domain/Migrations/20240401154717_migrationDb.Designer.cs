...
namespace TravelCapstone.BackEnd.Domain.Migrations
{
    ...
    [Migration("20240401154717_migrationDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelCapstone.BackEnd.Domain.Models.Communce", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelCapstone.BackEnd.Domain.Models.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelCapstone.BackEnd.Domain.Models.TravelCompanion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelCapstone.BackEnd.Domain.Models.Destination", b =>
                {
                    b.HasOne("TravelCapstone.BackEnd.Domain.Models.Communce", "Communce")
                        .WithMany()
            ...
            modelBuilder.Entity("TravelCapstone.BackEnd.Domain.Models.OrderDetail", b =>
                {
                    b.HasOne("TravelCapstone.BackEnd.Domain.Models.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelCapstone.BackEnd.Domain.Models.TravelCompanion", "TravelCompanion")
                        .WithMany()
            ...
            modelBuilder.Entity("TravelCapstone.BackEnd.Domain.Models.TourRegistration", b =>
                {
                    b.HasOne("TravelCapstone.BackEnd.Domain.Models.TravelCompanion", "Follower")
                        .WithMany()
                        .HasForeignKey("FollowerId");

                    b.HasOne("TravelCapstone.BackEnd.Domain.Models.TravelCompanion", "Presenter")
                        .WithMany()
