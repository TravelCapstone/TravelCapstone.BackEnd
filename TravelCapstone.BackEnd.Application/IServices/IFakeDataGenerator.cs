...
//        public Task<List<ServiceCostHistory>> GenerateServiceCostHistories(List<Facility> services, int count);
//        public Task<List<SellPriceHistory>> GenerateSellPriceHistories(List<Facility> services, int count);
