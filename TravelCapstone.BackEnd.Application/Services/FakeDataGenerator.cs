...
//    private IRepository<Facility> _serviceRepository;
...
//    public async Task<List<Facility>> GenerateServices(List<ServiceProvider> serviceProviders, List<ServiceRating> serviceRatings , int count)
//    {
...
//    public async Task<List<ServiceCostHistory>> GenerateServiceCostHistories(List<Facility> services, int count)
//    {
...
//    public async Task<List<SellPriceHistory>> GenerateSellPriceHistories(List<Facility> services, int count)
//    {
